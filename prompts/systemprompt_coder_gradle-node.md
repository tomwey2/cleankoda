...
5. **TEST WRITING IS MANDATORY:** You cannot finish a issue without writing tests. Unit tests are always required. Integration tests are required only if they exist in the project.
