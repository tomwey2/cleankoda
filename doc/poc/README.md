...
### Show Case
![Show Case](./cleankoda-poc-showcase-improve-readme.gif)
...
![Architecture](./cleankoda-poc-architecture.png)
...
![LangGraph Workflow](./cleankoda-poc-workflow-graph.png)
...
![Agent Dashboard](./cleankoda-poc-web-dashboard.png)
...
![Agent Settings](./cleankoda-poc-web-settings.png)
...
![Trello Board](./cleankoda-poc-trello-board.png)
...
## POC Results
[Results of the First POC](poc-results-01.md)
