...
- **Preis:** Dauerhaft 0 €
- **Monatliche Agenten-Läufe:** Bis zu 10 Jobs
- **Repository-Größe:** Maximal 50 MB
- **KI-Modelle:** Schnelle & effiziente Standard-Modelle (z. B. Gemini 1.5 Flash, GPT-3.5)
- **Parallelität:** 1 aktiver Job gleichzeitig (Warteschlangen-Prinzip)
- **Maximale Laufzeit:** 15 Minuten pro Job (Schutz vor Endlosschleifen)
...
**Features & Einschränkungen:**
- **Monatliche Agenten-Läufe:** Bis zu 100 Jobs
- **Repository-Größe:** Bis zu 500 MB
- **KI-Modelle:** Zugriff auf Premium-Modelle (wie GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro)
- **Parallelität:** 1 aktiver Job gleichzeitig
- **Maximale Laufzeit:** Satte 60 Minuten pro Job (Genug Zeit für tiefe Architektur-Analysen)
...
**Features & Einschränkungen:**
- **Monatliche Agenten-Läufe:** Bis zu 500 Jobs pro Workspace
- **Repository-Größe:** Bis zu 2.000 MB (2 GB)
- **Parallelität:** Bis zu 5 Agenten programmieren völlig zeitgleich an unterschiedlichen Tickets
- **Workspace-Management:** Gemeinsames Dashboard für das Team und zentrale Rechnungsstellung
- **Support:** Priority E-Mail Support
...
**Features & Einschränkungen:**
- **Monatliche Agenten-Läufe:** Maßgeschneiderte, unbegrenzte SLAs
- **Repository-Größe:** Unbegrenzt
- **KI-Modelle:** Voller Zugriff, optional Anbindung an unternehmenseigene, lokal gehostete LLMs (On-Prem API-Bridge)
- **Parallelität:** Gigantische parallele Verarbeitungskapazitäten ohne Flaschenhälse
- **Compliance:** Erweitertes Audit-Logging und SSO-Einbindung (Single Sign-On)
