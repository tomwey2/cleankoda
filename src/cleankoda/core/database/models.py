...
from cleankoda.core.security import EncryptedString
...
class UserDb(db.Model):
    ...
    # It is not automatically generated by SQLAlchemy, but is passed to Supabase
    # during login/signup and stored here.
    id = db.Column(db.String(36), primary_key=True)

    # --- App control & plans (Stripe Bridge) ---
    stripe_customer_id = db.Column(db.String(100), nullable=True)
    subscription_plan = db.Column(db.String(50), server_default="FREE", nullable=False)
    ...
    # --- GDPR (DSGVO) evidence (Consent Tracking) ---
    accepted_tos_at = db.Column(db.DateTime(timezone=True), nullable=True)
    accepted_privacy_at = db.Column(db.DateTime(timezone=True), nullable=True)
...
class UserCredentialDb(db.Model):
    ...
    api_token = db.Column(EncryptedString, nullable=True)
