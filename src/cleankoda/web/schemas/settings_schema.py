...
from cleankoda.core.types import IssueTrackingSystemType


class ItsConfigSchema(BaseModel):
    """Schema for Trello configuration form data."""

    its_base_url: str | None = Field(default=None, description="Base URL")
    its_container_id: str | None = Field(default=None, description="Container ID")
    its_parent_id: str | None = Field(default=None, description="Parent ID")
    its_state_backlog: str | None = Field(default=None, description="Backlog state")
    its_state_todo: str | None = Field(default=None, description="Todo state")
    its_state_in_progress: str | None = Field(default=None, description="In-progress state")
    its_state_in_review: str | None = Field(default=None, description="In-review state")
    its_state_done: str | None = Field(default=None, description="Done state")
    its_credential_id: int | None = Field(default=None, description="Credential ID")
    ...
    @classmethod
    def parse_its_credential_id(cls, v) -> int | None:
...
class LLMConfigSchema(BaseModel):
    ...
    llm_credential_id: int | None = Field(default=None, description="LLM Credential ID")
    llm_model_large: str | None = Field(default=None, description="Large model name")
    llm_model_small: str | None = Field(default=None, description="Small model name")
    llm_temperature: str | None = Field(default=None, description="LLM temperature")

    @field_validator("llm_provider", mode="before")
    @classmethod
    def default_provider(cls, v: str | None) -> str | None:
    ...
    @classmethod
    def parse_llm_credential_id(cls, v) -> int | None:
...
class SettingsFormSchema(BaseModel):
    ...
    agent_skill_level: str | None = Field(default=None, description="Agent skill level")
    agent_gender: str | None = Field(default=None, description="Agent gender")
    vcs_type: str = Field(default="GITHUB", description="Repository type")
    vcs_repo_url: str | None = Field(default=None, description="VCS Repository URL")
    vcs_credential_id: int | None = Field(default=None, description="VCS Credential ID")
    vcs_api_base_url: str | None = Field(default=None, description="VCS API Base URL")
    vcs_project_identifier: str | None = Field(default=None, description="VCS Project Identifier")
    vcs_default_branch: str | None = Field(default=None, description="VCS Default Branch")
    ...
    @classmethod
    def default_issue_system(cls, v: str | None) -> str:
    ...
    @classmethod
    def parse_vcs_credential_id(cls, v) -> int | None:
