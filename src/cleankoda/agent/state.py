...
from cleankoda.core.constants import TECH_STACKS
from cleankoda.core.extern.its.issue_tracking_system import IssueComment
from cleankoda.core.types import AgentStack, IssueStateType, IssueType, PlanState
...
def init_agent_state(runtime: "RuntimeSettings") -> AgentState:
