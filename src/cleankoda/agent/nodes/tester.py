...
from cleankoda.agent.nodes.base import invoke_tool_node
from cleankoda.agent.runtime import RuntimeSettings
from cleankoda.agent.services.prompts import load_prompt
from cleankoda.agent.services.summaries import append_agent_summary
...
def _get_report_result_args(response: Any) -> dict[str, Any] | None:
    """
...
def tests_passed(tool_args: dict[str, Any] | None) -> bool:
    """
