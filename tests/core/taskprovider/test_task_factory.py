"""
Tests for the task provider factory.
"""
...
def test_create_unknown_provider_raises_error():
    ...
    with pytest.raises(ValueError, match="Unknown task provider: unknown"):
        create_task_provider(agent_settings)
...
def test_provider_exposes_task_system(system_type, provider_cls, provider_key):
    ...
    task_system = TaskSystem(task_provider=provider_key)
